<template>
    <div  :class="{'videoEle': true, open: isPlayer, close: !isPlayer}" id="videoContainer"  v-drag>
        <Icon  name="close-circle" class="close-icon" @click="$emit('close')"></Icon>
        <video  id="videoEle" :src="src" controls playsinline loop autoplay></video>
    </div>
</template>
